...
<w:num w:numId="1"><w:abstractNumId w:val="0"/></w:num><w:num w:numId="2"><w:abstractNumId w:val="1"/></w:num>
    ...
    header=f'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:hdr xmlns:w="{WNS}"><w:p><w:pPr><w:jc w:val="right"/></w:pPr>{_run("GLIP")}</w:p></w:hdr>'
    footer=f'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:ftr xmlns:w="{WNS}"><w:p><w:pPr><w:jc w:val="center"/></w:pPr>{_run("GLIP  •  Página\u00a0")}<w:r><w:fldChar w:fldCharType="begin"/></w:r><w:r><w:instrText xml:space="preserve"> PAGE </w:instrText></w:r><w:r><w:fldChar w:fldCharType="end"/></w:r></w:p></w:ftr>'
